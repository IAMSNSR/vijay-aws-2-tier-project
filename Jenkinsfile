pipeline {
    ...
    stages {
        ...
        stage('Update helm values.yaml with New Docker Image') {
            environment {
                GIT_REPO_NAME = "vijay-aws-2-tier-helm-chart"
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh """
                        ...
                        sed -i "s|image: 597619205814.dkr.ecr.us-east-1.amazonaws.com/frontend-repo:.*|image: 657001761946.dkr.ecr.us-east-1.amazonaws.com/frontend-repo:${IMAGE_TAG}|" helm-chart/values.yaml
                        sed -i "s|image: 597619205814.dkr.ecr.us-east-1.amazonaws.com/backend-repo:.*|image: 657001761946.dkr.ecr.us-east-1.amazonaws.com/backend-repo:${IMAGE_TAG}|" helm-chart/values.yaml
